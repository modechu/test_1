...
{
	$this->filed_1(10,28,28,15,7,"Receive #",'80,110,140',$parm['rcv_num']);	
	$this->filed_1(40,28,50,15,7,'Invoice','80,110,140',$parm['inv_nun']);
	$this->filed_1(92,28,75,15,7,'Supplier Name','80,110,140',$parm['sup_name'],'L');
	$this->filed_1(169,28,30,15,7,'Supplier #','80,110,140',$parm['sup_code']);
	$this->filed_1(201,28,35,15,7,'Dept.','80,110,140',$parm['dept']);
	$this->filed_1(238,28,35,15,7,'Rcvd. Date','80,110,140',$parm['sub_date']);
...
function filed_1($x,$y,$w,$h,$h2,$title,$color,$field,$alin='C') {
	...
	if ($title == 'Dept.' || $title == 'Supplier Name'){
