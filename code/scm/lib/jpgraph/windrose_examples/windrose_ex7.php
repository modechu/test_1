...
// Description:	Example 7 of how to use windrose plots
// Created: 	2003-11-08
//========================================================================
*/
...
// (Note: The Swedish spelling of "SSW" since we further
// down changes the label for the compass directions)
//---------------------------------------------------------
$data = array(
    2 => array(1,15,7.5,2),
    5 => array(1,1,1.5,2),
    7 => array(1,2,10,3,2),
    'SSV' => array(2,3,1,3,1,2),
    );
