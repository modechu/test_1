...
// Created: 	2006-08-21
// Ver:		$Id: encodation-200.inc.php 886 2007-04-08 08:35:21Z ljp $
//
...
class Encodation_200 {
    ...
    var $iError=0;
    var $i144NonStandard=false; // Should we use the non-standard way of interleaving for 144x144 symbol
    var $iSelectSchema = ENCODING_ASCII, $iShift=0;
    var $iCurrentEncoding = ENCODING_ASCII; // Keep track of the current encoding we are in
    ...
    var $iSymbolSizes = array(array(3,5),array(5,7),array(8,10),array(12,12),array(18,14),
