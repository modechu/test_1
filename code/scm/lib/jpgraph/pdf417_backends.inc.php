...
// Created: 	2004-02-25
// Ver:		$Id: pdf417_backends.inc.php 972 2008-02-17 21:35:21Z ljp $
//
...
class BarcodePrintSpecPDF417 {
    ...
    function BarcodePrintSpecPDF417() {
	$this->iBar = array();
    }
...
class OutputBackendPDF417_IMAGE extends OutputBackendPDF417 {
    ...
    function OutputBackendPDF417_IMAGE($aEncoder) {
...
class OutputBackendPDF417_PS extends OutputBackendPDF417 {
    ...
    function OutputBackendPDF417_PS($aEncoder) {
	$this->iEncoder = $aEncoder;
	$this->iFontSize = 12;
