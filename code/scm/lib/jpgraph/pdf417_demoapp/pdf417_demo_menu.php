...
<!-- <form name="barcodespec" action="pdf417_demo_image.php" target=barcode -->
<!-- onclick="top.debug.location='pdf417_demo_debug.php';" method post> -->

<div align=center>

<form name="barcodespec" action="demo_imgframes.php" target=imgframes method post>
<H2>JpGraph PDF417 Demo</h2>

<table cellspacing=4 cellpadding=0 style="background:lightgray;border:black solid 1pt;">
<tr>
<td colspan=2>
Data:<br>
