...
class PDF_shidoc_inv_ab extends PDF_Chinese 	{
...
function hend_title($parm)
{
	...
	$this->SetFont('Arial','',9);
	$this->Cell(75, 5,$parm['invoice_of'],0,0,'L',0);
...
function item_title($ship_term,$des,$tuc)
{
		...
		$this->ln();	
		$this->SetFont('Arial','',8);
		$this->Cell(170, 5,$des,0,1,'L',0);
		$this->Cell(170, 5,$tuc,0,1,'L',0);			
}
...
function item_txt($parm)
{
		...
		$this->ln();
		$this->Cell(15, 4,'LINE: ',0,0,'L',0);
		$this->Cell(180, 4,$parm['line'],0,0,'L',0);
		$this->ln();		
...
function item_total($parm,$charge)
{
		$vl1 = $vl2 = '';
