...
class PDF_shidoc_inv extends PDF_Chinese 	{
...
//	$this->SetFont('Arial','',9);
//	$this->Cell(85, 5,$parm['inv_num'],1,0,'L',0);
	...
	{
		$this->SetFont('Arial','B',10);
		$this->Cell(40, 5,"COUNTRY OF ORIGIN:",0,0,'L',0);
		$this->SetFont('Arial','',9);
		$this->Cell(50, 5,$parm['country_org'],0,0,'L',0);		
	}
	$this->ln();
	...
	{
		$this->SetFont('Arial','B',10);
		$this->Cell(26, 5,"ISSUING BANK:",0,0,'L',0);
		$this->SetFont('Arial','',9);
		$this->Cell(74, 5,$parm['bank'],0,0,'L',0);
		$this->ln();
	}
	$yy = $this->GetY();
	$this->SetY(($yy+2));
