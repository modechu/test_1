...
function Header() {
	...
	global $print_title;
	global $print_inv;
	global $print_consignee;
	global $print_address;
	global $print_shipdate;
	global $print_factory;
	...
	$print_address = str_replace(' – ',' - ',$print_address);
	//echo $print_address;
	//exit;
	$dt = decode_date(1);
	//Put watermark
	...
	$this->RotatedText(60,180,$mark,45);
	//Logo
	$w =$this->GetStringWidth($print_title) +30;
	$this->Image('./images/logo10.jpg',10,8,50);
	//echo $print_address;
	//exit;
	//title
	$this->SetXY(85,15);
	...
	$this->Cell(50, 7,$print_title,1,0,'C',0);
	$this->SetXY(140,18);
	$this->SetFont('big5','B',10);
	$this->Cell(60, 7,$print_title3,0,0,'C',0);
	$this->SetXY(25,25);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','B',10);
	$this->Cell(12, 7,'INVOICE NO:',0,0,'R',0);
	$this->SetXY(40,25);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','',10);
	$this->Cell(12, 7,$print_inv,0,0,'L',0);
	$this->SetXY(25,30);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','B',10);
	$this->Cell(12, 7,'CONSIGNEE:',0,0,'R',0);
	$this->SetXY(40,30);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','',10);
	$this->Cell(12, 7,$print_consignee,0,0,'L',0);
	$this->SetXY(25,35);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','B',10);
	$this->Cell(12, 7,'ADDRESS:',0,0,'R',0);
	$this->SetXY(40,35);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','',10);
	$this->MultiCell(150, 3,$print_address,0,'L',0);
	$this->SetXY(25,40);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','B',10);
	$this->Cell(12, 7,'Shipped by:',0,0,'R',0);
	$this->SetXY(40,40);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','',10);
	$this->Cell(12, 7,$print_factory,0,0,'L',0);//MultiCell(150, 7,$print_factory,0,'L',0);
	$this->SetXY(25,45);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','B',10);
	$this->Cell(12, 7,'Shipping Date:',0,0,'R',0);
	$this->SetXY(40,45);
	$this->SetTextColor(40,40,40);
	$this->SetFont('Arial','',10);
	$this->Cell(12, 7,$print_shipdate,0,0,'L',0);//MultiCell(150, 7,$print_shipdate,0,'L',0);
	$this->Line(10,25,194,25);
	$this->ln(1);
	$this->SetLineWidth(0.1);
	$this->SetDrawColor(0,0,0);
	$this->Line(10,50,194,50);
	$this->ln(1);
	$this->SetLineWidth(0.1);
	$this->SetDrawColor(0,0,0);
	//$this->Cell(12, 7,$print_address,0,0,'L',0);
	/* $this->SetXY(130,13);
	$this->SetFont('big5','B',10);
	$this->Cell(60, 7,$print_title2,0,0,'C',0);
	$this->SetXY(132,18);
	$this->Cell(60, 7,$print_title3,0,0,'C',0);
	$this->SetXY(180,18);
...
function hend_title($parm)
{
	if($parm == '')
	{
			$this->Cell(20,7,'INVOICE',1,0,'C');
			$this->Cell(20,7,'PO',1,0,'C');
			$this->Cell(30,7,'Style',1,0,'C');
			$this->Cell(40,7,'Color',1,0,'C');
			$this->Cell(20,7,'Size',1,0,'C');
			//$this->Cell(40,7,'Unit Price',1,0,'C');
			$this->Cell(20,7,'Qty',1,0,'C');
			$this->Cell(20,7,'Unit Price',1,0,'C');
			$this->Cell(25,7,'Amount',1,0,'C');
			//$this->Cell(10,7,'缸號',1,0,'C');
			//$this->Cell(20,7,'異動日期',1,0,'C');
			/* $this->Cell(25,7,'異動類別',1,0,'C'); */
			//$this->Cell(20,7,'異動數量',1,0,'C');
	}
	else
	{
		if($parm == 'nocolor')
		{
			$this->Cell(20,7,'INVOICE',1,0,'C');
			$this->Cell(30,7,'PO',1,0,'C');
			$this->Cell(50,7,'Style',1,0,'C');
			$this->Cell(20,7,'Qty',1,0,'C');
			//$this->Cell(40,7,'Unit Price',1,0,'C');
			$this->Cell(20,7,'Unit Price',1,0,'C');
			$this->Cell(25,7,'Amount',1,0,'C');
