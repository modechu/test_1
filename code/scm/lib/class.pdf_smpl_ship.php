...
class PDF_smpl_ship extends PDF_Chinese 	{
...
function Header() {
	...
	if( $print_title == 'HJ') $print_title = "湖嘉廠 -- 樣品出貨明細[".$mark."]";
	if( $print_title == 'LY') $print_title = "立元廠 -- 樣品出貨明細[".$mark."]";
	if( $print_title == 'CL') $print_title = "中壢廠 -- 樣品出貨明細[".$mark."]";
	if( $print_title == 'WX') $print_title = "無錫廠 -- 樣品出貨明細[".$mark."]";
	if( $print_title == 'KA') $print_title = "貿易業務部A組 -- 樣品出貨明細[".$mark."]";
	if( $print_title == 'KB') $print_title = "貿易業務部B組 -- 樣品出貨明細[".$mark."]";
...
function top($parm)
{	
	if($parm['ship_to'] == 'KA') $parm['ship_to'] = '貿易業務A組';
	if($parm['ship_to'] == 'KB') $parm['ship_to'] = '貿易業務B組';
	
	$this->SetFont('BIG5','',12);
	$this->Cell(20,5,'Ship date : ',0,0,'L');
	$this->Cell(50,5,$parm['ship_date'],0,0,'L');
	$this->Cell(18,5,'Ship to : ',0,0,'L');
	$this->Cell(110,5,$parm['ship_to'],0,0,'L');	
