...
class PDF_trans_rcvd extends PDF_Chinese 	{
...
function hend_title($parm)
{
	...
	$this->filed_1(10,28,50,15,7,"Receive #",'80,110,140',$parm['rcv_num']);	
	$this->filed_1(62,28,60,15,7,'Source FTY','80,110,140',$parm['new_fty']);
	$this->filed_1(124,28,60,15,7,'Receiver','80,110,140',$parm['org_fty']);
	//$pdf->filed_1(109,28,32,15,7,'季節','80,110,140','');
	$this->filed_1(186,28,50,15,7,'Order #','80,110,140',$parm['ord_num']);
	$this->filed_1(238,28,45,15,7,'Rcvd. Date','80,110,140',$parm['sub_date']);
...
function filed_1($x,$y,$w,$h,$h2,$title,$color,$field,$alin='C') {
	...
	if ($title == 'Source FTY' || $title == 'Receiver'){$this->SetFont('big5','IB',12);}else{$this->SetFont('Arial','IB',12);}
...
function rcv_title()
{
	...
	$this->Cell(38,10,'Material #',1,0,'C');
	$this->Cell(70,10,'Name',1,0,'C');
	$this->Cell(70,10,'Color/cat.',1,0,'C');

	$this->Cell(48,10,'Transport Q\'ty',1,0,'C');
	$this->Cell(48,10,'Q\'ty',1,0,'C');	

	//雙線
	$this->ln();
	$this->Cell(38,0.5,'',1,0,'C');
	$this->Cell(70,0.5,'',1,0,'C');
	$this->Cell(70,0.5,'',1,0,'C');
	$this->Cell(48,0.5,'',1,0,'C');
	$this->Cell(48,0.5,'',1,0,'C');	
}
...
function rcv_det($rcv)
{
	...
	$this->Cell(38,5,$rcv['mat_code'],1,0,'C');
	$this->SetFont('big5','',10);
	$this->Cell(70,5,$rcv['mat_name'],1,0,'L');
	$this->Cell(70,5,$rcv['color'],1,0,'L');
	$this->SetFont('Arial','',10);	
	$this->Cell(48,5,$rcv['trn_qty'].' '.$rcv['unit'],1,0,'R');
	$this->Cell(48,5,$rcv['rcv_qty'].' '.$rcv['unit'],1,0,'R');	
	$this->ln();
}
