...
function hend_title($parm)
{
	...
	$this->filed_1(70,28,35,15,7,$parm['prt_ord'],'80,110,140',$parm['PHP_id']);
	$this->filed_1(108,28,40,15,7,'Customer','80,110,140',$parm['cust']);
	//$pdf->filed_1(109,28,32,15,7,'季節','80,110,140','');
	$this->filed_1(150,28,45,15,7,'Customer ref.','80,110,140',$parm['ref']);


	$this->filed_1(70,50,25,15,7,'Dept.','80,110,140',$parm['dept']);
	$this->filed_1(98,50,40,15,7,'Size / Style','80,110,140',$parm['size_scale'].' /  '.$parm['style']);
	$this->filed_1(140,50,30,15,7,'Q\'ty','80,110,140',$parm['qty'].' '.$parm['unit']);
	$this->filed_1(172,50,23,15,7,'ETD','80,110,140',$parm['etd']);

/*
	$this->filed_1(10,28,26,15,7,$parm['prt_ord'],'80,110,140',$parm['PHP_id']);
	$this->filed_1(37,28,28,15,7,'Customer','80,110,140',$parm['cust']);
	//$pdf->filed_1(109,28,32,15,7,'季節','80,110,140','');
	$this->filed_1(66,28,35,15,7,'Customer ref.','80,110,140',$parm['ref']);
	$this->filed_1(102,28,15,15,7,'Dept.','80,110,140',$parm['dept']);
	$this->filed_1(118,28,35,15,7,'Size / Style','80,110,140',$parm['size_scale'].' /  '.$parm['style']);
	$this->filed_1(154,28,20,15,7,'Q\'ty','80,110,140',$parm['qty'].' '.$parm['unit']);
	$this->filed_1(175,28,22,15,7,'ETD','80,110,140',$parm['etd']);
*/
...
function Table_2_title($title,$header1,$w1,$use_title,$R,$G,$B)
{
  ...
  {
    //$color_size = $etd_size / sizeof($use_title[$key]);
...
//	foreach($use_title as $key => $value)$this->Cell($etd_size,5,$key,1,0,'C',0);
...
function Table_2($row,$w1) {
	...
	$this->Ln();
	$this->SetFont('BIG5','',8);
	$this->Cell(180.5,5,$row['des_m'],1,0,'L',0);
  $this->SetFillColor(200);
