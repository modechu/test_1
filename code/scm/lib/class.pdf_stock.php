...
function Header() {
	...
	$this->SetXY(197,18);
	$this->Cell(90, 7,$print_title3,0,0,'C',0);
	$this->SetXY(180,18);
...
function hend_title($parm)
{
	...
	$this->Cell(45,7,'Name',1,0,'C');
	$this->Cell(50,7,'Color',1,0,'C');
	$this->Cell(10,7,'Size',1,0,'C');
	$this->Cell(10,7,'C/no',1,0,'C');
	$this->Cell(10,7,'D/L',1,0,'C');
	$this->Cell(10,7,'R/no',1,0,'C');
	$this->Cell(15,7,'Qty',1,0,'C');
	$this->Cell(12,7,'Unit',1,0,'C');
	$this->Cell(18,7,'Storage',1,0,'C');
	$this->Cell(20,7,'Currency',1,0,'C');
	$this->Cell(20,7,'Price',1,0,'C');
	$this->Cell(20,7,'Amount',1,0,'C');
}
