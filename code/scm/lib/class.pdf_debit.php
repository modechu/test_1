...
class PDF_DEBIT extends PDF_Chinese 	{
...
function Header() {
  ...
  //Put watermark
   ...
   $this->RotatedText(60,150,$ord_num,30);
	//Logo
...
function title($field) {	//title
	...
	$this->Cell(30, 5,'DEBIT NOTE # : ',0,0,'L');
	$this->Cell(40, 5,$field['dn_num'],0,0,'L');
	$this->ln();
	$this->SetFont('Arial','B',10);
	$this->Cell(20, 5,'FROM: ',0,0,'L');
	$this->SetFont('BIG5','B',10);
	$this->Cell(40, 5,$field['dn_user']." (".$field['dept'].")",0,0,'L');
	if($field['cust_po'])
	{
		$this->SetFont('Arial','B',10);
		$this->Cell(24, 7,'Cust. refer. # :',0,0,'L');
		$this->SetFont('Arial','B',10);
		$this->Cell(46, 7,$field['cust_po'],0,0,'L');
	}
	if($field['po_num'])
	{
		$this->SetFont('Arial','B',10);
		$this->Cell(20, 7,'Our P.O.#  :',0,0,'L');
		$this->SetFont('Arial','B',10);
		$this->Cell(20, 7,$field['po_num'],0,0,'L');
	}


//	$this->SetFont('BIG5','B',12);
//	$this->Cell(20, 5,'報告日期 : ',0,0,'L');
//	$this->SetFont('Arial','B',12);
//	$this->Cell(40, 5,$field['dn_date'],0,0,'L');
//	$this->SetFont('BIG5','B',12);
//	$this->Cell(20, 5,'報告人 : ',0,0,'R');
//	$this->Cell(20, 5,$field['dn_user'],0,0,'L');		
	$this->ln();
	$this->SetFont('Arial','B',10);
	$this->Cell(20, 7,'TO Messrs : ',0,0,'L');
	$this->SetFont('BIG5','B',10);
	$this->Cell(110, 7,$field['dn_to_f_name'],0,0,'L');
	$this->ln();

	$this->SetFont('Arial','B',10);
	$this->Cell(20, 7,'Amount : ',0,0,'R');
	$this->Cell(20, 7,$field['currency']." $ ".$field['dn_price'],0,0,'L');		
	$this->ln();
	$this->SetFont('Arial','B',10);
	$this->Cell(22, 7,'Our refer. # : ',0,0,'L');
	$this->Cell(110, 7,$field['ord_num'],0,0,'L');
	$this->ln();
