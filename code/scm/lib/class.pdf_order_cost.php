...
function Header() {
	...
	$this->Cell(80, 7,$print_title,1,0,'C',0);
	$this->SetXY(170,13);
	...
	$this->Line(10,25,295,25);
	$this->ln(1);
	$this->SetLineWidth(0.1);
	$this->SetDrawColor(0,0,0);
	$this->Line(10,26,295,26);
	$this->ln(7);
	$this->SetFont('big5','B',10);
...
{
	$this->Cell(25,7,'訂單號碼',1,0,'C');
	$this->Cell(35,7,'品名',1,0,'C');
	$this->Cell(25,7,'顏色',1,0,'C');
	$this->Cell(25,7,'請購數量',1,0,'C');
	$this->Cell(25,7,'請購金額',1,0,'C');
	$this->Cell(25,7,'採購數量',1,0,'C');
	$this->Cell(25,7,'採購金額',1,0,'C');
	$this->Cell(25,7,'驗收數量',1,0,'C');
	$this->Cell(25,7,'驗收金額',1,0,'C');
	$this->Cell(25,7,'領用數量',1,0,'C');
	$this->Cell(25,7,'領用金額',1,0,'C');
}
