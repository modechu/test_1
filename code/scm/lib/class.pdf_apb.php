...
class PDF_rcvd extends PDF_Chinese 	{
...
function Header() {
	...
	$this->Line(10,25,288,25);
	$this->ln(1);
	$this->SetLineWidth(0.1);
	$this->SetDrawColor(0,0,0);
	$this->Line(10,26,288,26);
	$this->ln(5);
...
function hend_title($parm)
{
	...
	$this->SetXY(10,28);
	$this->Cell(35,7,'驗收單號',1,0,'C');
	$this->Cell(28,7,$parm['apb_num'],1,0,'C');
	$this->Cell(25,7,'申請單位',1,0,'C');
	$this->Cell(30,7,$parm['apb_dept'],1,0,'C');
	$this->Cell(25,7,'單位代號',1,0,'C');
	$this->Cell(27,7,$parm['dept_code'],1,0,'C');
	$this->Cell(25,7,'申請日期',1,0,'C');
	$this->Cell(25,7,$parm['apb_date'],1,0,'C');
	$this->Cell(25,7,'經辦',1,0,'C');
	$this->Cell(33,7,$parm['rcv_user'].$parm['rcv_user_id'],1,0,'C');
	$this->ln();
	$this->Cell(35,7,'憑據',1,0,'C');
	$this->Cell(135,7,'□ 發 票    張       □ 簽 呈    張       □ 收 據    張       □ 其 他       ',1,0,'L');
	$this->Cell(108,7,'□ 費 用 支 出           □ 其 他 支 出       ',1,0,'C');

	$this->ln();
	$this->Cell(35,7,'付款方式',1,0,'C');
	$this->Cell(243,7,'□ 現 金 票       ■ 匯 款       □ 請 開    日 期 票       □ 沖 銷 借 款 單 傳 票 編 號        □ 其 他       ',1,0,'L');

	$this->ln();
	$this->Cell(35,7,'受款人',1,0,'C');
	$this->Cell(135,7,$parm['supplier'],1,0,'L');
	$this->Cell(23,7,'統一編號',1,0,'C');
	$this->Cell(85,7,$parm['uni_no'],1,0,'L');
	$this->ln();
    
    $this->Cell(35,7,'統一發票',1,0,'C');
    $this->Cell(50,7,$parm['inv_num'],1,0,'C');
    $this->Cell(35,7,'發票日期',1,0,'C');
    $this->Cell(50,7,$parm['inv_date'],1,0,'C');
    $this->Cell(23,7,'INVOICE #',1,0,'C');
	if(strlen($parm['foreign_inv_num'])>50)
		$this->SetFont('Big5','',8);
    $this->Cell(85,7,$parm['foreign_inv_num'],1,0,'C');
    $this->ln();
		
	/* $this->filed_1(10,28,26,15,7,"申請單位",'80,110,140',$parm['apb_dept']);
	$this->filed_1(38,28,124,15,7,'單位代號','80,110,140', $parm['dept_code']);
	$this->filed_1(164,28,26,15,7,'申請日期','80,110,140',$parm['apb_date']);
	$this->filed_1(192,28,38,15,7,'受款人','80,110,140',$parm['supplier']);
	$this->filed_1(232,28,28,15,7,"統一編號",'80,110,140',$parm['uni_no']); */
