...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	function add($parm) {
		...
		if ($sql->num_rows($q_result) ) {
			$this->msg->add("SORRY ! 這個尺碼類別已經登錄了，請換別的類別或更改原內容!");
			return false;    	    
		}
					# 加入資料庫
		...
		$this->msg->add("成功 新增尺碼類別 : [".$parm['size_type']."]。") ;
		return $size_type_id;

	} // end func
	
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#	->search($mode=0)	搜尋 尺碼類別	 
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#	->get($id=0, size_type=0)	抓出指定記錄內資料 RETURN $row[]
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
###########  撿查 新加入的 size_type 是否為唯一 [note:可能會找到原來的自己 #####
$q_str2 = "SELECT id FROM size_type WHERE size_type='".$parm['size_type']."'"." AND id <> '".$parm['id']."'";
		...
		if ($sql->num_rows($q_result2) ) {
			$this->msg->add("SORRY ! 這個尺碼類別已經登錄資料庫內，請換別的名稱或是更新原記錄!");
			return false;    	    
		}
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	function del($id) {
		...
		$sql = $this->sql;
		if (!$id) {
			$this->msg->add("Error !請指明 size_type 資料表的 ID.");		    
			return false;
		}
