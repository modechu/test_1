...
function Header() {
	...
	$this->Cell(70, 7,$print_title,1,0,'C',0);
...
{
	$this->Cell(30,7,'採購單',1,0,'C');
	$this->Cell(30,7,'訂單號碼',1,0,'C');
	$this->Cell(40,7,'品名',1,0,'C');
	$this->Cell(75,7,'顏色',1,0,'C');
	$this->Cell(20,7,'尺碼',1,0,'C');
	$this->Cell(25,7,'採購量',1,0,'C');
	$this->Cell(25,7,'驗收量',1,0,'C');
	$this->Cell(25,7,'驗收累計',1,0,'C');
}
